...
namespace Drupal\Tests\unocha_demo_content\Functional;
...
class UninstallDefaultContentTest extends BrowserTestBase {
  ...
  public function testReinstall() {
    ...
    $module_installer->uninstall(['unocha_demo_content']);
    ...
    $module_installer->install(['unocha_demo_content']);
    $this->assertRecipesImported($node_storage);
    $this->assertImportedCustomBlock($block_storage);
